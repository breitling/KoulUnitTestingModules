...
import org.breitling.dragon.framework.jdbc.LongRowMapper;
...
//  EXTRA DB METHODS
    ...
    public Long getLong(final String query)
    {
        List<Long> values = this.executeQuery(query, new LongRowMapper());
